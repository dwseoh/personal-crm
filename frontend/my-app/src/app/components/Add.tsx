  ...
  return (
    <>
      <button
        ...
        className="fixed bottom-6 right-6 w-14 h-14 bg-accent text-primary-content hover:bg-opacity-90 rounded-full shadow-lg z-50 flex items-center justify-center transition-all duration-200 hover:scale-105"
      >
